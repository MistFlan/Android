...
import com.flandre.android.activity.NewsContentActivity
import com.flandre.android.dto.News
...
class NewsTitleFragment : Fragment() {
    ...
    private fun getNews(): List<News> {
        ...
        for (i in 1..50) {
            val news =
                News("This is news title $i", getRandomLengthString("This is newscontent $i ."))
            newsList.add(news)
        }
        return newsList
    }
